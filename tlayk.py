...
def action():
    ...
    if bch == '':
        ...
        os.system('clear')
        print logo
        print '0750 0751 0752 0770 0771 0772 0773 0774 0780 0781 0782 0783'
        try:
        ...
        os.system('clear')
        print logo
        print '\x1b[1;96m 750 751 752 770 771 772 773 774 780 781 782 783 784'
        try:
            c = raw_input(' choose code  : ')
            k = '+964'
            idlist = '.txt'
